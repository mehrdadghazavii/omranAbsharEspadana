...
import {getProblemCMPReport} from "api/api";
import 'date-fns';
...
function ProblemCMPPage({startDate, endDate}: any) {
  ...
  const getAllNeedData = async () => {
    const res = await getProblemCMPReport(projectId,
