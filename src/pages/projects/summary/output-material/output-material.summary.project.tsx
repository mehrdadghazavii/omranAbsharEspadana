...
import { getOutputMaterialSummaryReport} from "api/api";
...
function OutputMaterialSummaryPage({startDate, endDate}: any) {
  ...
  const getAllNeedData = async () => {
    const res: any = await getOutputMaterialSummaryReport(projectId, startDate, endDate)
...
export {OutputMaterialSummaryPage}